...
- [`MCP.md`](MCP.md) — the MCP connector operator runbook: endpoints, adding/revoking the Claude
  connector, the kill switch, the WAF rule, the dev smoke procedure. **Not yet released.**
...
- **"How does the Claude/MCP connector work, and how do I add or revoke it?"** → [MCP.md](MCP.md)
