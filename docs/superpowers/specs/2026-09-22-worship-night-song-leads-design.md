...
**Date:** 2026-09-22 · **Status:** spec, pending Frank's read · **Risk tier:** mixed — the
setlist writer and the proposal-approval carry-over are a **critical** slice (§9); the rest
is standard · **Builds on:** PR #90 (`special_role.time`) and PR #91 (stored-mode group fill)
· **Motivating event:** the Campamento's Noche de Alabanza, Saturday 3 October 2026, 20:45.
