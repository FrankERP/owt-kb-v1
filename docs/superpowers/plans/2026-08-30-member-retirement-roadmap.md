...
| R18 | Kids: retiro sin efecto operativo, declarado | P1 § Requirements | P1 | — | P1 |
...
| D9 Retiro en kids | Es un hecho de **registro**: no cambia nada operativo, y la UI lo dice | El modelo de kids empareja gente. La candidatura es de `kidsPair`, no del miembro, y las tres lecturas de kids llevan indisponibilidad y resolución de nombre — filtrarlas no saca a nadie de la rotación, le borra su indisponibilidad y le rompe el nombre. Estrictamente peor que no hacer nada. **No revierte D1:** el eje sigue siendo por ministerio; lo que se declara es que en kids todavía no mueve nada. | Kids se queda sin forma de sacar a una persona sin sacar a su pareja, hasta que alguien construya el equivalente de P3 para kids. Elección de Frank, con las tres opciones sobre la mesa. | Frank |
