...
- [ADR-0023: The message thread does not bump `APPROVAL_RECEIPT_VERSION`](0023-thread-does-not-bump-the-approval-receipt.md) — why a field added to `setlistProposal` is not a "fingerprinted shape change", and what bumping it would do to 13 live approval receipts
