...
- [ADR-0035: The publish transition's setlist notice is not debounced](0035-the-publish-notice-is-not-debounced.md) — why «Setlist listo» took 5–10 minutes to reach the team, why retuning the debounce globally and raising the Scheduler to `*/1` were both rejected, and what publish-then-edit costs now
