...
**311 test files / 5,471 tests** (276 under `app/` + 26 under `scripts/` + 9 harness unit
tests under `e2e/service-readiness/__tests__/`), counted 2026-09-17 (R5 tip, after the
whole-branch review fix wave and its round 2).
