...
**279 test files / 5,144 tests** (244 under `app/` + 26 under `scripts/` + 9 harness unit
tests under `e2e/service-readiness/__tests__/`), counted 2026-09-13.
