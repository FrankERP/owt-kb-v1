...
//
// Layer 1 (`/api/cron/flush-notifications`, driven by Cloud Scheduler and
// GitHub Actions on a five-minute schedule) and layer 3 (the existing daily Vercel cron) are asserted here; layer
