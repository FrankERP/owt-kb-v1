  ...
  return (
    <div className="min-h-[70svh] flex flex-col items-center justify-center gap-6 px-6 text-center">
      ...
      <div className="space-y-2">
        <h1 className="font-display text-2xl md:text-3xl font-bold">Página no encontrada</h1>
        <p className="font-body text-sm text-mono-400 max-w-sm mx-auto">
          Esta página no existe o su enlace cambió. Puede que haya sido movida o eliminada.
        </p>
      </div>
