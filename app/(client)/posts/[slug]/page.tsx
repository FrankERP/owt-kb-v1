  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-20">
        ...
        {/* Audio */}
        {hasAudio && (
          <section id="audio" className="scroll-mt-32 lg:scroll-mt-40">
        ...
        {/* Tutoriales */}
        {hasTutorials && (
          <section id="tutoriales" className="scroll-mt-32 lg:scroll-mt-40">
        ...
        {/* Reference Links */}
        {hasRefLinks && (
          <section id="referencia" className="scroll-mt-32 lg:scroll-mt-40">
        ...
        {/* Letra / Body */}
        {hasLyrics && (
          <section id="letra" className="scroll-mt-32 lg:scroll-mt-40">
        ...
        {/* Historial */}
        {hasHistory && (
          <section id="historial" className="scroll-mt-32 lg:scroll-mt-40">
