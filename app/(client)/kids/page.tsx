  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-4xl px-6 pt-10 pb-16 space-y-8">
        <div className="flex flex-wrap items-center justify-between gap-3" {...revealProps(0)}>
          <h2 className="font-display text-2xl md:text-3xl font-bold">Próximos domingos</h2>
          {managesKids && (
            <Button variant="secondary" size="lg" href="/kids/admin">
              Planear Kids
        ...
        {sundays.length === 0 ? (
          <div className="flex flex-col items-center gap-3 py-20 text-mono-600" {...revealProps(1)}>
            ...
            {sundays.map(({ day, row, mine }, i) => (
              ...
              >
                <header className="flex flex-wrap items-baseline justify-between gap-2">
                  ...
                  {mine.length > 0 && (
                    <span className="animate-pop rounded-full border border-accent px-3 py-1 font-label text-[11px] uppercase tracking-widest text-accent">
