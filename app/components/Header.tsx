...
const Header = ({ title = "", tags = false, author = "" }: Props) => {
  return (
    <header className="pb-14 px-4 mb-12 text-center shadow-accent mx-auto min-w-10 w-full sm:w-[75vw] md:w-[50vw] max-w-2xl  shadow-bottom">
      ...
      {tags ? (
        <div className={`${authorFont.className}  text-bold text-lg mt-2 hover:text-accent`}>
