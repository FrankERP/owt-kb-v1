...
const Header = ({ title = "", tags = false, author = "", timeSig = "", bpm = "", tone= "" }: Props) => {
  return (
    <header className="pb-14 px-4 mb-12 text-center shadow-[#002249] mx-auto min-w-10 w-full sm:w-[75vw] md:w-[50vw] max-w-2xl  shadow-bottom dark:shadow-[#00bfff]">
      ...
      {timeSig ? (
        <h2 className={`${authorFont.className} text-bold uppercase text-lg sm:text-md md:text-lg lg:text-xl mb-4`}>{timeSig}</h2>
      ):(
        <h2 className={`${authorFont.className}  uppercase text-lg sm:text-md md:text-lg lg:text-xl mb-4`}>{" "}</h2>
      )}
      {bpm ? (
        <h2 className={`${authorFont.className} text-bold uppercase text-lg sm:text-md md:text-lg lg:text-xl mb-4`}>{bpm}</h2>
      ):(
        <h2 className={`${authorFont.className}  uppercase text-lg sm:text-md md:text-lg lg:text-xl mb-4`}>{" "}</h2>
      )}
      {tone ? (
        <h2 className={`${authorFont.className} text-bold uppercase text-lg sm:text-md md:text-lg lg:text-xl mb-4`}>{tone}</h2>
      ):(
        <h2 className={`${authorFont.className}  uppercase text-lg sm:text-md md:text-lg lg:text-xl mb-4`}>{" "}</h2>
      )}
    </header>
