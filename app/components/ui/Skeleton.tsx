...
export function NavbarSkeleton() {
  return (
    <div aria-hidden="true" className="pt-[env(safe-area-inset-top)]">
      <div className={`mx-auto max-w-7xl ${NAVBAR_H_CLASS} flex items-center gap-3 sm:gap-5 ps-[max(1.25rem,env(safe-area-inset-left))] pe-[max(1.25rem,env(safe-area-inset-right))] border-b border-surface-accent-20`}>
