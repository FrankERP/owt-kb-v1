...
// drag-to-dismiss, and rendering NOTHING while closed. A closed CueDialog still
// subscribes to the dialog context, so a page with many rows owns ONE of these
// (`LibraryIndex`) and hands rows an `onQuickActions` callback; a handful of rows
// (`DayCardDisclosure`) may own their own. It is mounted with `open={open}`, never
