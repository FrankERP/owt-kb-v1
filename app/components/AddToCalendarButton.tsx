...
export default function AddToCalendarButton({ services }: { services: ICSEvent[] }) {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 px-3.5 py-2.5 rounded-lg border border-surface-accent-30 font-label text-[11px] uppercase tracking-widest text-gray-400 hover:border-accent hover:text-accent transition-colors"
    >
