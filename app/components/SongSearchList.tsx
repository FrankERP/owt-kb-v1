    ...
    <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="brand-search-console relative w-full sm:max-w-md">
          ...
          {query && (
            <button
              ...
              className="absolute right-2.5 top-1/2 -translate-y-1/2 rounded-md p-1 text-ink-dim transition-colors hover:text-accent focus:outline-none focus:ring-2 focus:ring-accent/50"
            >
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 lg:gap-4 xl:grid-cols-4">
        {filtered.length > 0 ? (
          ...
          <div className="col-span-full flex flex-col items-center gap-3 py-20 text-mono-400">
