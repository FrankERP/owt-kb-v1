 ...
 * at all. Layer 1 sweeps afterwards — five-minutely from Cloud Scheduler
 * (ADR-0032); the GitHub caller alone was starved when the repo is busy with
 * CI, anywhere from half an hour to many hours (docs/NOTIFICATIONS.md), a delay rather
