    ...
    rules: {
      "no-restricted-syntax": [
        ...
        },
        {
          ...
          selector:
            "Literal[value=/\\b(bg|text|border|ring|divide|from|via|to|fill|stroke|shadow|outline|decoration|caret|accent)-(surface-accent|surface-ink|edge-accent|edge-control|placeholder|warning-glow|skeleton-base|skeleton-sweep)[a-z0-9-]*\\/[0-9]/]",
          message:
